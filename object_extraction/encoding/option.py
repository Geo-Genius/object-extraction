...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--dataset', type=str, default='norm',
                            help='dataset name (default: pascal12)')
        parser.add_argument('--data-folder', type=str,
                            default='/home/jixf/potsdam',
        ...
        parser.add_argument('--img-paths', type=str, default='./',
                            help='img obs paths')
        parser.add_argument('--label-paths', type=str, default='./',
                            help='label obs paths')
        parser.add_argument('--div-ratio', type=float, default=0.7,
                            help='train val div ratio')
