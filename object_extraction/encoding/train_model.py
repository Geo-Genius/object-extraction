...
class Trainer():
    def __init__(self, args, pre_train_model):
        ...
        trainset = get_segmentation_dataset(args.dataset, root=args.data_folder, split='train', mode='train',
                                            **data_kwargs)
        testset = get_segmentation_dataset(args.dataset, root=args.data_folder, split='val', mode='val',
                                           **data_kwargs)
        # dataloader
...
def train_process(data_folder, output_path, epochs, pre_train_model):
    args = Options().parse()
